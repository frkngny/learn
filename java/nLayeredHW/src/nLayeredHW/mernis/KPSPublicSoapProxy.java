...
public class KPSPublicSoapProxy implements nLayeredHW.mernis.KPSPublicSoap {
  private String _endpoint = null;
  private nLayeredHW.mernis.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new nLayeredHW.mernis.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public nLayeredHW.mernis.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
