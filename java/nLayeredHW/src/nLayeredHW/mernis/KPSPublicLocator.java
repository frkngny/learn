...
package nLayeredHW.mernis;

public class KPSPublicLocator extends org.apache.axis.client.Service implements nLayeredHW.mernis.KPSPublic {
    ...
    public nLayeredHW.mernis.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public nLayeredHW.mernis.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            nLayeredHW.mernis.KPSPublicSoapStub _stub = new nLayeredHW.mernis.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (nLayeredHW.mernis.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                nLayeredHW.mernis.KPSPublicSoapStub _stub = new nLayeredHW.mernis.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
